...
import { postUserReg } from '../../../redux/actionCreators.js'
...
const Register = () => {
  ...
  const onSubmit = (data) => {
    console.log(data)
    // const {name, workEmail, password } = data
    // useJwt
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      invalid={errors.workEmail && true}
                      {...field}
                    />
                  )}
                />
                {errors.workEmail ? <FormFeedback>{errors.workEmail.message}</FormFeedback> : null}
              </div>
              <div className='mb-1'>
            ...
            <p className='text-center mt-2'>
              <span className='me-25'>Уже есть аккаунт?</span>
              <Link to='/login'>
                <span>Тогда войдите</span>
              </Link>
            </p>
